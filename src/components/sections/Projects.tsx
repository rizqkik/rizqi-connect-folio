      ...
      <Shell>
        ...
        <Reveal delay={60}>
          <p className="mt-4 max-w-2xl text-[0.975rem] leading-relaxed text-muted-foreground">
            Selected works across network engineering, AI, and IoT/robotics. Each project includes documentation and media — click to view the full Drive folder.
          </p>
        </Reveal>
        ...
        <div className="mt-16 space-y-16">
          {domains.map((domain) => {
            ...
            return (
              <div key={domain}>
                <Reveal>
                  <h3 className="text-lg font-medium tracking-tight mb-8">{DOMAIN_LABELS[domain]}</h3>
                </Reveal>
                <ol>
                      ...
                      >
                        <div className="grid gap-3 py-7 md:grid-cols-[48px_minmax(0,1.1fr)_minmax(0,1fr)_100px] md:items-baseline md:gap-8">
                          ...
                          <div className="min-w-0">
                            <h3 className="flex items-baseline gap-3 text-base font-medium tracking-tight transition-transform duration-300 ease-out group-hover:translate-x-1">
                              {project.title}
                              <Arrow />
                            </h3>
